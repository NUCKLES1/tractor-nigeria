    ...
    <div className="flex h-screen max-md:h-[70vh] max-md:block w-full pt-20">
      ...
      <div className="flex relative text-white z-30 w-[40%] max-md:w-10/12 mt-2 flex-col gap-[26px] row-start-2 md:items-start">
        <motion.h1
          ...
          className=" text-6xl max-md:text-5xl font-bold"
        >
        ...
        <div className="flex gap-4 lg:items-center  max-md:flex-row relative z-0">
          ...
          <Button
            size="lg"
            variant="outline"
            className="bg-white/10 backdrop-blur-sm border-white text-white hover:bg-white/20 !rounded-button whitespace-nowrap cursor-pointer"
          >
            Rent Now
          </Button>
        </div>
      </div>
      <div className="absolute max-md:mt-20 lg:bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-gray-50 to-transparent z-10"></div>
    </div>
  );
};
