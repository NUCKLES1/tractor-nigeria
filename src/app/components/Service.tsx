              ...
              <div className="p-6">
                ...
                <div className="mt-6">
                  <Button className="w-full bg-purple-600 hover:bg-purple-700 !rounded-button whitespace-nowrap">
                    <i className="fas fa-calendar-check mr-2"></i> Schedule
                    Appointment
                  </Button>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      Our factory-trained technicians are certified experts on
                      all tractor models, ensuring your equipment receives the
                      highest quality service with manufacturer-approved parts
                      and procedures.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      Advanced diagnostic tools identify issues with pinpoint
                      accuracy, allowing us to resolve problems efficiently and
                      prevent future failures through predictive maintenance.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-3">
                    <AccordionTrigger>Mobile Service Options</AccordionTrigger>
                    <AccordionContent>
                      Cant bring your tractor to us? Our mobile service units
                      come to your location, equipped with all necessary tools
                      and parts to perform repairs and maintenance on-site.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-4">
                    <AccordionTrigger>Digital Service Records</AccordionTrigger>
                    <AccordionContent>
                      All maintenance and repairs are documented in our digital
                      system, giving you access to complete service history,
                      maintenance schedules, and warranty information through
                      our mobile app.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
                ...
                <div className="mt-8 bg-purple-50 rounded-xl p-4 border border-purple-100">
                  ...
                  <p className="text-sm text-purple-700 mb-4">
                    Unexpected breakdown? Our emergency service team is
                    available 24/7 to get you back up and running with minimal
                    downtime.
                  </p>
                  <Button
                    variant="outline"
                    className="bg-white text-purple-700 border-purple-200 hover:bg-purple-50 hover:text-purple-800 hover:border-purple-300 !rounded-button whitespace-nowrap"
                  >
                    <i className="fas fa-phone-alt mr-2"></i> Emergency Service
                    Hotline
                  </Button>
                </div>
              </div>
