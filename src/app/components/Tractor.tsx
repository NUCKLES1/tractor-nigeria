      ...
      const chartRef = useRef<HTMLDivElement>(null);
        ...
        const tractors = [
          ...
          },
          {
            ...
            price: 65000,
            rentalPrice: 750,
            image: "https://readdy.ai/api/search-image?query=Compact%20modern%20tractor%20with%20futuristic%20design%2C%20lightweight%20frame%2C%20smart%20connectivity%20features%20visible%2C%20on%20a%20simple%20gradient%20background%2C%20photorealistic%2C%20product%20photography%2C%20clean%20minimal%20background%2C%20high-end%20commercial%20product%20shot&width=600&height=400&seq=tractor3&orientation=landscape",
            description: "Compact and versatile model ideal for small to medium farms with smart connectivity.",
            features: ["IoT Integration", "Compact Design", "Multi-Tool Support", "Weather Adaptation", "Farm Data Analytics"]
          },
          {
            id: 4,
        ...
        useEffect(() => {
          if (chartRef.current) {
            ...
            const option = {
              ...
              legend: {
                data: ['NeoTrac X9000', 'EcoTrac E750', 'AgroTrac A500', 'HyperTrac H1000'],
                bottom: 0
              },
              grid: {
                left: '3%',
              ...
              xAxis: {
                type: 'category',
                data: ['Efficiency', 'Power', 'Eco-Friendly', 'Smart Features', 'Durability']
              },
              yAxis: {
                type: 'value',
                max: 100
    ...
    <section id="buy" className="py-16 bg-gradient-to-b from-gray-50 to-white">
           <div className="container mx-auto lg:px-4">
             <div className="text-center mb-12">
               ...
               <h2 className="text-3xl md:text-4xl font-bold mb-4">Explore Our Cutting-Edge Tractors</h2>
               <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                 From compact models to heavy-duty powerhouses, find the perfect tractor for your agricultural needs.
               </p>
             </div>
             ...
             <Tabs defaultValue="buy" className="w-full" onValueChange={setActiveTab} value={activeTab}>
               <div className="flex justify-center mb-8">
                 <TabsList className="grid w-full max-w-md grid-cols-3">
                   ...
                   <TabsTrigger value="rent" className="!rounded-button whitespace-nowrap">Rent</TabsTrigger>
                   <TabsTrigger value="compare" className="!rounded-button whitespace-nowrap">Compare</TabsTrigger>
                 </TabsList>
               </div>
                       ...
                       <CardHeader className="pb-2">
                         <div className="flex justify-between items-start">
                           <div>
                             ...
                             <CardTitle className="text-xl">{tractor.name}</CardTitle>
                           </div>
                           <Button variant="ghost" size="icon" className="text-gray-500 hover:text-blue-600 !rounded-button whitespace-nowrap">
                            <Heart />
                           </Button>
                         </div>
                       </CardHeader>
                       <CardContent className="pb-2 -mt-4">
                         <p className="text-gray-600 text-sm mb-4">{tractor.description}</p>
                       ...
                       <CardFooter className="flex -mt-4 gap-2">
                         ...
                         <Dialog>
                           <DialogTrigger asChild>
                             <Button variant="outline" size="icon" className="!rounded-button whitespace-nowrap">
                           ...
                           <DialogContent className="sm:max-w-[900px]">
                             <DialogHeader>
                               ...
                               <DialogDescription>
                                 {tractor.category} - Advanced Agricultural Technology
                               </DialogDescription>
                             </DialogHeader>
                               ...
                               <div className="rounded-lg overflow-hidden">
                                 ...
                                 <div className="flex justify-center mt-4 gap-2">
                                   <Button variant="outline" size="sm" className="!rounded-button whitespace-nowrap">
                                     <i className="fas fa-cube mr-2"></i> View 3D Model
                                   </Button>
                                   <Button variant="outline" size="sm" className="!rounded-button whitespace-nowrap">
                                     <i className="fas fa-vr-cardboard mr-2"></i> VR Tour
                                   </Button>
                                 </div>
                               </div>
                               <div>
                                 ...
                                 <div className="space-y-4">
                                   <div>
                                     ...
                                     <p className="text-sm">Advanced Hybrid PowerTrain with Electric Boost</p>
                                   </div>
                                   <div>
                                     <h4 className="text-sm font-medium text-gray-500">Power Output</h4>
                                     <p className="text-sm">450 HP with 30% Energy Recovery</p>
                                   </div>
                                   <div>
                                     <h4 className="text-sm font-medium text-gray-500">Smart Features</h4>
                                     <p className="text-sm">AI Crop Analysis, Autonomous Navigation, Remote Control</p>
                                   </div>
                                   <div>
                                     <h4 className="text-sm font-medium text-gray-500">Connectivity</h4>
                                     <p className="text-sm">5G-enabled Farm Management System Integration</p>
                                   </div>
                                   <div>
                                     <h4 className="text-sm font-medium text-gray-500">Warranty</h4>
                                     <p className="text-sm">5-Year Comprehensive with 24/7 Tech Support</p>
                                   </div>
                                 </div>
                                 ...
                                 <div className="mt-6">
                                   ...
                                   <div className="flex gap-2">
                                     ...
                                     <Button variant="outline" className="flex-1 !rounded-button whitespace-nowrap">
                                       <i className="fas fa-calendar-alt mr-2"></i> Rent
                                     </Button>
                                   </div>
                                 </div>
                               </div>
                     ...
                     <Card key={tractor.id} className="overflow-hidden transition-all hover:shadow-md border-gray-200">
                       ...
                       <CardHeader className="pb-2">
                         <div className="flex justify-between items-start">
                           ...
                           <Button variant="ghost" size="icon" className="text-gray-500 hover:text-green-600 !rounded-button whitespace-nowrap">
                       ...
                       <CardContent className="pb-2">
                         ...
                         <div className="mb-4">
                           <div className="flex justify-between mb-2">
                             <span className="text-sm text-gray-600">Rental Duration: {rentalDuration[0]} days</span>
                             <span className="text-sm font-medium">{rentalDuration[0]} days</span>
                           </div>
                           <Slider
                             defaultValue={[7]}
                             max={30}
                         ...
                         <div className="text-2xl font-bold text-green-700">
                           ${(tractor.rentalPrice * rentalDuration[0]).toLocaleString()}
                           <span className="text-sm font-normal text-gray-500 ml-1">for {rentalDuration[0]} days</span>
                         </div>
                       </CardContent>
                       ...
                       <table className="w-full min-w-[800px]">
                         <thead>
                           <tr className="bg-gray-50">
                             ...
                             {tractors.map(tractor => (
                               <th key={tractor.id} className="px-4 py-3 text-left text-sm font-medium text-gray-500">
                                 {tractor.name}
                               </th>
                             ))}
                           </tr>
                         ...
                         <tbody className="divide-y divide-gray-200">
                           <tr>
                             ...
                             {tractors.map(tractor => (
                               <td key={tractor.id} className="px-4 py-3 text-sm text-gray-700">
                                 ${tractor.price.toLocaleString()}
                               </td>
                             ))}
                           </tr>
                           <tr>
                             <td className="px-4 py-3 text-sm text-gray-700 font-medium">Daily Rental</td>
                             {tractors.map(tractor => (
                               <td key={tractor.id} className="px-4 py-3 text-sm text-gray-700">
                           ...
                           <tr>
                             <td className="px-4 py-3 text-sm text-gray-700 font-medium">Category</td>
                             {tractors.map(tractor => (
                               <td key={tractor.id} className="px-4 py-3 text-sm text-gray-700">
                                 {tractor.category}
                               </td>
                           ...
                           <tr>
                             <td className="px-4 py-3 text-sm text-gray-700 font-medium">Features</td>
                             {tractors.map(tractor => (
                               <td key={tractor.id} className="px-4 py-3 text-sm text-gray-700">
